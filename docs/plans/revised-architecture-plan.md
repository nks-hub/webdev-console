...
- [ ] **Self-update mechanism** — still deferred. Velopack / Squirrel.Windows / hand-rolled GitHub releases check. Users can re-download from the releases page in the interim.
...
- [ ] **Windows Firewall rule registration** for managed service ports (80/443/3306/6379/1025/8025) — `netsh advfirewall` helper to pre-register rules on first daemon run, avoiding per-first-bind UAC prompt. Still deferred.
