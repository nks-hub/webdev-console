  ...
  <div class="mcp-activity-page" role="region" :aria-label="t('mcpActivity.stats.totalCalls')">
    ...
    <div v-if="stats" class="activity-stats">
      <div
        ...
        :aria-label="`${t('mcpActivity.stats.totalCalls')}: ${stats.total}`"
      ...
      <div
        ...
        :aria-label="`${t('mcpActivity.stats.reads')}: ${stats.reads}`"
      ...
      <div
        ...
        :aria-label="`${t('mcpActivity.stats.mutates')}: ${stats.mutates}`"
      ...
      <div
        ...
        :aria-label="`${t('mcpActivity.stats.destructives')}: ${stats.destructives}`"
    ...
    <div v-else-if="viewMode === 'sessions'" class="sessions-list">
      ...
      >
        <div
          ...
          :aria-label="t('mcpActivity.session.toggle', { caller: session.caller })"
        ...
        >
          ...
          <code
            ...
            :aria-label="t('mcpActivity.filterBySession', { id: session.sessionId.slice(0, 8) })"
