...
public class WindowsFirewallManagerTests
{
    ...
    {
        var previous = Environment.GetEnvironmentVariable("NKS_WDC_SKIP_FIREWALL_RULES");
        Environment.SetEnvironmentVariable("NKS_WDC_SKIP_FIREWALL_RULES", "1");
        try
        {
        ...
        {
            Environment.SetEnvironmentVariable("NKS_WDC_SKIP_FIREWALL_RULES", previous);
        }
    }
