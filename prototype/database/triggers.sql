...
CREATE TRIGGER trg_php_versions_updated_at
...
CREATE TRIGGER trg_settings_audit_insert
...
CREATE TRIGGER trg_settings_audit_update
    AFTER UPDATE ON settings
    FOR EACH ROW
...
CREATE TRIGGER trg_settings_audit_delete
...
CREATE TRIGGER trg_sites_audit_insert
...
CREATE TRIGGER trg_sites_audit_update
    AFTER UPDATE ON sites
    FOR EACH ROW
...
CREATE TRIGGER trg_sites_audit_delete
...
CREATE TRIGGER trg_services_audit_insert
...
CREATE TRIGGER trg_php_versions_audit_insert
...
CREATE TRIGGER trg_php_versions_audit_update
    AFTER UPDATE ON php_versions
    FOR EACH ROW
...
CREATE TRIGGER trg_php_versions_audit_delete
...
CREATE TRIGGER trg_php_versions_prevent_delete_default
...
CREATE TRIGGER trg_php_versions_single_default_insert
    AFTER INSERT ON php_versions
    FOR EACH ROW
...
CREATE TRIGGER trg_php_versions_single_default_update
